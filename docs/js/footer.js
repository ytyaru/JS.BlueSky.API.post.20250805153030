...
'
    ...
    #copyright() { return small('©', time({datetime:this._created}, '20250805152948
'), this.#author()) }
    ...
    #project() { return a(this.#externalLinkAttr(({href:`https://github.com/${this._author}/BlueSky.API.post/`})), img({class:'icon', src:`${this._prePath}asset/image/logo/github/black.svg`})) }
